...
def menu():
    ...
    os.system("clear")
    print("Coded By: \033[1;36m Murilo \033[m and \033[1;36m Macedo ios \033[m in 30/03/2021")
    print()
    os.system("figlet murilo")
    #print(f'{C}[{G}*{C}] Bem vindo,' + user)
    print()
    print("\033[32m{1} BUSCADOR DE CEP\033[m")
    print("\033[32m{2} GEO LOCALIZADOR DE IP\033[m")
    print("\033[32m{3} Info de Sites\033[m")
...
""")
    ...
    if op == '1' or op == '01':
        def main():
            ...
            clear()
            print("\033[32m.............\033[m")
            print("\033[32m.digite o ip.\033[m")
            print("\033[32m.............\033[m")
    ...
    if op == '99' or op == '99':
        os.system("clear")
        os.system("pip update && pip update")
        menu()
    ...
    if op == '2' or op == '02':
        def ip():
            from requests import get
            os.system("clear")
            print("\033[32mdigite aq\033[m")
            print("\033[32m#ihu#\033[m")
            print("\033[32m######\033[m")
